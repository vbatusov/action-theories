...
class Semantics(object):
    """ Gets a sit. calc. initial theory, converts to Prolog clauses (if possible),
        ...
        A note on usage:
          This semantics does not understand situation calculus, situations, or actions.
          It cannot apply UNA and things like that. Any incoming formula must be in simple FOL,
          with all fancy bits simplified away preemptively.
    """
    ...
    def __str__(self):
        return "SLDNF-Resolution Semantics using SWI Prolog"
    ...
    def eval_query(self, query):
        ...
        #print(f"(Semantics) Incoming query: {query.tex()}")
