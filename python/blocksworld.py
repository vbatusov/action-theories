...
sigma_3 = Do(ActionTerm("move", A, B), sigma_2)
#sigma_4 = Do(ActionTerm("move", , ), sigma)
q = []
q.append(EqAtom(B, ObjFluent("on", A, sigma_3)))
q.append(PossAtom(ActionTerm("move", A, B), sigma_1))
q.append(RelFluent("clear", C, sigma_2))
query = And(*q)
print("\nQuery:")
print(f"\nQuery: ${query.tex()}$")
regr = bat.rho(query, S_0)
